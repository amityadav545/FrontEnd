                        ...
                        <Nav as="ul" className="mb-2 ms-auto navbar-list mb-lg-0">
                            ...
                            <Dropdown as="li" className="nav-item">
                                ...
                                <Dropdown.Menu className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item ><Link to="/dashboard/app/user-profile">Profile</Link></Dropdown.Item>
                                    <Dropdown.Item ><Link to="/dashboard/app/user-privacy-setting">Privacy Setting</Link></Dropdown.Item>
                                    <Dropdown.Divider />
                                    <Dropdown.Item >
                                        <Link to="/sign-in">Logout</Link></Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Nav>
                    </Navbar.Collapse>
