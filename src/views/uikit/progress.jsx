          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/progress"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-progress-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-progress-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  ...
                  />
                  <ProgressBar
                    className="mb-3 text-dark w-100"
                    now={50}
                    label={`50%`}
                    variant="info"
                  />
