          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/carousel"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Carousel-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Carousel-code"
                    type="button"
                    role="tab"
