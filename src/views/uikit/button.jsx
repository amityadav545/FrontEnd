          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/buttons"
                  target="_blank"
                >
                  <svg
                    width="20"
          ...
          <Tab.Container defaultActiveKey="first">
              ...
              <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Button-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Button-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content className="">
              ...
              >
                ...
                <div className="bd-example">
                  <Button type="button" variant="primary mr-2" size="xs">
                    Ex small
                  </Button>{" "}
